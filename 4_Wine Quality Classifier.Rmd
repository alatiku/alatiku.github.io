...
# wine_data <- read.csv("Data_files/winequality-white.csv", sep = ";")
...
2. The ensemble model, AdaBoost model, produced good result 'Accuracy', 'Precision' and 'Recall' but there might be still room for improvement. This could also be improved using hyper-parameter tuning or more feature engineering such as PCA or scaling.
